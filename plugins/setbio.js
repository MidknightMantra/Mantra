...
const QUOTE_URLS = [
  'https://raw.githubusercontent.com/MidknightMantra/Islamic-Database/main/text/random_quotes.txt',
  'https://raw.githubusercontent.com/MidknightMantra/Islamic-Database/main/text/motivational_quotes.txt',
  'https://raw.githubusercontent.com/MidknightMantra/Islamic-Database/main/text/pickup_quotes.txt'
];
...
async function fetchQuotes() {
  try {
    ...
    return cachedQuotes.length > 0 ? cachedQuotes : ['💎 By Mantra - Your WhatsApp Bot'];
  }
}

function getRandomQuote(quotes) {
  if (!quotes || quotes.length === 0) return '💎 By Mantra';
