...
let phoneNumber = global.PAIRING_NUMBER || process.env.PAIRING_NUMBER || "254743032398";
let owner = JSON.parse(fs.readFileSync('./data/owner.json'));

global.botname = process.env.BOT_NAME || "Mantra";
global.themeemoji = "•";
    ...
    try {
        ...
        QasimDev.ev.on('connection.update', async (s) => {
            ...
            if (connection == "open") {
                ...
                await delay(1999);
                console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ ${global.botname || 'Mantra'} ]`)}\n\n`));
                console.log(chalk.cyan(`< ================================================== >`));
                console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL: MidknightMantra`));
                console.log(chalk.magenta(`${global.themeemoji || '•'} GITHUB: MidknightMantra`));
                console.log(chalk.magenta(`${global.themeemoji || '•'} WA NUMBER: ${owner}`));
                console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: Midknight Mantra`));
...
async function main() {
    printLog('info', 'Starting Mantra BOT...');
