...
async function handleMessages(sock, messageUpdate) {
    try {
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, { 
                    text: '*Join our Channel:*\n[https://whatsapp.com/channel/0029Vb74Dlf4CrfoqpAEBC2T](https://whatsapp.com/channel/0029Vb74Dlf4CrfoqpAEBC2T)' 
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, { 
                    text: `*Support*\n\nhttps://whatsapp.com/channel/0029Vb74Dlf4CrfoqpAEBC2T` 
                }, { quoted: message });
                return;
            }
        }
